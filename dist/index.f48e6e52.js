...
})({"e7vid":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "a197c850f48e6e52";
"use strict";
...
},{}],"2xzZx":[function(require,module,exports) {
(function(global, factory) {
    factory(require("19cbb940130842fb"), require("c318eba3e81d4d95"));
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label (ctx) {
                            ...
                            if (!helpers.isNullOrUndef(point.y)) return chart_js.defaults.plugins.tooltip.callbacks.label(ctx);
                            const { o, h, l, c } = point;
    ...
    class OhlcElement extends FinancialElement {
        ...
        draw(ctx) {
            ...
            if (close < open) ctx.strokeStyle = helpers.valueOrDefault(me.options.borderColors ? me.options.borderColors.up : undefined, defaults.elements.ohlc.borderColors.up);
            else if (close > open) ctx.strokeStyle = helpers.valueOrDefault(me.options.borderColors ? me.options.borderColors.down : undefined, defaults.elements.ohlc.borderColors.down);
            else ctx.strokeStyle = helpers.valueOrDefault(me.options.borderColors ? me.options.borderColors.unchanged : undefined, defaults.elements.ohlc.borderColors.unchanged);
...
},{"19cbb940130842fb":"ipU8D","c318eba3e81d4d95":"dxsY3"}],"ipU8D":[function(require,module,exports) {
/*!
 * Chart.js v4.4.3
...
},{"./chunks/helpers.segment.js":"7oQuk","@kurkle/color":"2aojw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["e7vid","2xzZx"], "2xzZx", "parcelRequire30ab")

//# sourceMappingURL=index.f48e6e52.js.map
