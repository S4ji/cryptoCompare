...
})({"ijsWo":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "c742f4d31cfdd09a";
"use strict";
...
},{}],"9nPB7":[function(require,module,exports) {
...
async function processBTCData() {
    ...
    const labels = filteredData.map((element)=>formatTime(element.time));
    ...
    // console.log('labels', low24group)
    // let dataObjectForGraph = filteredData.reduce((arrays, item) => {
    //     Object.keys(item).forEach((key) => {
    //         if (key in arrays) {
    //             arrays[key] = [...arrays[key], item[key]]
    //         } else {
    //             arrays[key] = [item[key]]
    //         }
    //     })
...
},{"chart.js":"ipU8D","chartjs-chart-financial":"4tkKb"}],"ipU8D":[function(require,module,exports) {
/*!
 * Chart.js v4.4.3
...
},{}],"4tkKb":[function(require,module,exports) {
/*!
 * @license
...
class FinancialElement extends (0, _chartJs.BarElement) {
    static defaults = {
        backgroundColors: {
...
class OhlcElement extends FinancialElement {
    ...
    draw(ctx) {
        ...
        const armLengthRatio = (0, _helpers.valueOrDefault)(me.armLengthRatio, defaults.elements.ohlc.armLengthRatio);
        let armLength = (0, _helpers.valueOrDefault)(me.armLength, defaults.elements.ohlc.armLength);
        ...
        if (close < open) ctx.strokeStyle = (0, _helpers.valueOrDefault)(me.options.borderColors ? me.options.borderColors.up : undefined, defaults.elements.ohlc.borderColors.up);
        else if (close > open) ctx.strokeStyle = (0, _helpers.valueOrDefault)(me.options.borderColors ? me.options.borderColors.down : undefined, defaults.elements.ohlc.borderColors.down);
        else ctx.strokeStyle = (0, _helpers.valueOrDefault)(me.options.borderColors ? me.options.borderColors.unchanged : undefined, defaults.elements.ohlc.borderColors.unchanged);
        ctx.lineWidth = (0, _helpers.valueOrDefault)(me.lineWidth, defaults.elements.ohlc.lineWidth);
        ctx.beginPath();
        ctx.moveTo(x, high);
        ctx.lineTo(x, low);
...
class OhlcController extends FinancialController {
    ...
    updateElements(elements, start, count, mode) {
        ...
        for(let i = start; i < start + count; i++){
            ...
            if (includeOptions) baseProperties.options = options;
...
class CandlestickElement extends FinancialElement {
    ...
    draw(ctx) {
        ...
        let borderColor;
        if (close < open) {
            borderColor = (0, _helpers.valueOrDefault)(borderColors ? borderColors.up : undefined, (0, _chartJs.defaults).elements.candlestick.borderColors.up);
            ctx.fillStyle = (0, _helpers.valueOrDefault)(me.options.backgroundColors ? me.options.backgroundColors.up : undefined, (0, _chartJs.defaults).elements.candlestick.backgroundColors.up);
        } else if (close > open) {
            borderColor = (0, _helpers.valueOrDefault)(borderColors ? borderColors.down : undefined, (0, _chartJs.defaults).elements.candlestick.borderColors.down);
            ctx.fillStyle = (0, _helpers.valueOrDefault)(me.options.backgroundColors ? me.options.backgroundColors.down : undefined, (0, _chartJs.defaults).elements.candlestick.backgroundColors.down);
        } else {
            borderColor = (0, _helpers.valueOrDefault)(borderColors ? borderColors.unchanged : undefined, (0, _chartJs.defaults).elements.candlestick.borderColors.unchanged);
            ctx.fillStyle = (0, _helpers.valueOrDefault)(me.backgroundColors ? me.backgroundColors.unchanged : undefined, (0, _chartJs.defaults).elements.candlestick.backgroundColors.unchanged);
        }
        ctx.lineWidth = (0, _helpers.valueOrDefault)(me.options.borderWidth, (0, _chartJs.defaults).elements.candlestick.borderWidth);
...
class CandlestickController extends FinancialController {
    ...
    static defaultRoutes = (0, _chartJs.BarController).defaultRoutes;
    updateElements(elements, start, count, mode) {
        const reset = mode === "reset";
        const ruler = this._getRuler();
        const { sharedOptions, includeOptions } = this._getSharedOptions(start, mode);
...
},{"./chunks/helpers.segment.js":"7oQuk","@kurkle/color":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ijsWo","9nPB7"], "9nPB7", "parcelRequire30ab")

//# sourceMappingURL=index.1cfdd09a.js.map
